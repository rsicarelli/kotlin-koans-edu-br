...
class DefaultArgumentsTests {
    ...
    @Test
    fun `DADO um nome e um número, QUANDO a função foo é chamado, ENTÃO deve retornar a concatenação do nome e número`() {
        // DADO
        val name = "test"
        val number = 123
    ...
    @Test
    fun `DADO um nome e um número, com a opção de tornar maiúsculo, QUANDO a função foo é chamado, ENTÃO deve retornar a concatenação do nome (em maiúsculas) e número`() {
        // DADO
        val name = "test"
        val number = 123
    ...
    @Test
    fun `QUANDO a função useFoo é chamado, ENTÃO deve retornar uma lista com strings formatadas corretamente`() {
        // QUANDO
