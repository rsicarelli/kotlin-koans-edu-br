...
class NamedArgumentsTests {
    ...
    @Test
    fun `DADO uma lista de opções, QUANDO a função joinOptions é chamado, ENTÃO ele deve retornar as opções em uma String formatada corretamente`() {
        // DADO
    ...
    @Test
    fun `DADO uma lista vazia, QUANDO a função joinOptions é chamado, ENTÃO ele deve retornar uma String com brackets vazios`() {
        // DADO
